    ...
    createHistoryTopTabs = () => {
      return (
        <MaterialTopTabs.Navigator 
          ...
          <MaterialTopTabs.Screen initialParams={{ type: "Beğeni" }}  name="Like" component={HistoryScreen} options={{ title: 'i', tabBarIcon: ({ color }) => (
                <View>
                    ...
                    headerLeft: () => (
                      <Button  navigation={this.navigation} style={{ elevation:0, backgroundColor:"transparent", marginLeft:10}}>
                        <View style={{flexDirection:'row', justifyContent:'center', paddingRight:13, backgroundColor:this.props.themeColors.actionTabShopBackground, borderRadius:20 ,
                          ...
                          <View style={{justifyContent:'center'}}>
                            <Text style={{color:this.props.themeColors.actionTabShopTint, fontFamily:FontFamilies.navTitle, fontSize:19, bottom:-1}}> Mağaza</Text>
                          </View>
                        </View>
                      </Button>
                    ),
