...
export class CollectionRow extends Component {
        ...
        return (
            <View style={{flex:1, flexDirection:'row', backgroundColor:this.props.themeColors.screenBackground}}>
                <View style={{flex:1, right:0, justifyContent:'center', opacity:0.3,  alignItems:'center'}}>
                    <SvgXml width='20' height='20' style={{}} fill={this.props.themeColors.historyTypeIconTint} xml={SVGs.collectionUncolored}></SvgXml>
                </View>
                ...
                <View style={{flex:1, flexDirection:'row', borderRadius:10, overflow:'hidden'}}>
                        <View style={{flex:8, flexDirection:'column', paddingHorizontal:15, paddingVertical:10}}>
                            ...
                            <View style={{flex:1, justifyContent:'flex-start'}}>
                                <ProgressBar progress={item.done/item.total} color={isDone ? this.props.themeColors.historyRowComplete : this.props.themeColors.historyRowUncomplete} style={{top:3, borderRadius:5, height:10}} />
                            </View>
                            </View>
                        </View>
...
export default connect(mapStateToProps)(CollectionRow);
