...
class NotificationCollectionRow extends Component {
    constructor(props) {
        super(props);
    }
                ...
                <Animatable.View animation={this.props.unread ? "flash" : "fadeIn"}  iterationCount={1} style={{flexDirection:'row', paddingHorizontal:10}}>
                    {
                        ...
                        <View style={{justifyContent:'center', alignItems:'center'}}>
                            <View style={{width:5, aspectRatio:1, backgroundColor:this.props.themeColors.collectionMain, borderRadius:3}} />
                        </View>
                    }
                        ...
                        <View style={{width:'100%', justifyContent:'center'}}>
                            <View style={{flex:1, flexDirection:'row', justifyContent:'center'}}>
                                <View style={{width:40, left:0, justifyContent:'center', opacity:.8, alignItems:'center'}}>
                                    <SvgXml width='22' height='22' fill={this.props.themeColors.collectionMain} xml={SVGs.collectionUncolored}></SvgXml>
                                </View>
                                <View style={{flex:14, flexDirection:'column', paddingHorizontal:5, paddingVertical:10}}>
                                    <View style={{paddingRight:10}}>
                                        <Text style={{fontFamily:FontFamilies.actionHeaderContent, fontSize:15, marginTop:6, color:this.props.themeColors.notificationsText, lineHeight:19}}>
                                            <Text style={{color:this.props.themeColors.collectionMain, fontSize:17, fontFamily:FontFamilies.actionHeaderTitle,}}>{this.props.count} koleksiyon</Text>
                                            {" "}alımı başarıyla tamamlandı{" "}
                                            <Text style={{color:this.props.themeColors.notificationsDate, fontSize:15, fontFamily:FontFamilies.actionHeaderContent,}}>1w</Text>
                                        </Text>
                                    </View>
                                </View>
...
export default connect(mapStateToProps)(NotificationCollectionRow);
